...
io.popen("cd library && wget https://raw.githubusercontent.com/AIANu/AIAN/main/library/redis.lua") 
...
os.execute('wget https://raw.githubusercontent.com/AIANu/AIAN/main/AIAN.lua')
